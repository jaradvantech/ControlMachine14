...
int Synchro::GetSynchronizationPointValue(unsigned int IndexOfSynchronizationPoint) {
...
void Synchro::IncreaseSynchronizationPointValue(
		unsigned int IndexOfSynchronizationPoint) {
	std::lock_guard < std::mutex > lockGuard(SynchronizationPoints_mutex);
	if (IndexOfSynchronizationPoint == SynchronizationPoints_List.size()) {
	...
	void Synchro::DecreaseSynchronizationPointValue(unsigned int IndexOfSynchronizationPoint)
	{
		std::lock_guard<std::mutex> lockGuard(SynchronizationPoints_mutex);
